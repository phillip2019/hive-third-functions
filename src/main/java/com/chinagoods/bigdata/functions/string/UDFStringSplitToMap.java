...
public class UDFStringSplitToMap extends GenericUDF {
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException {
        ...
        Failures.checkCondition(entryDelimiter.length() > 0, "entryDelimiter is empty");
        Failures.checkCondition(keyValueDelimiter.length() > 0, "keyValueDelimiter is empty");
        Failures.checkCondition(!entryDelimiter.equals(keyValueDelimiter), "entryDelimiter and keyValueDelimiter must not be the same");
